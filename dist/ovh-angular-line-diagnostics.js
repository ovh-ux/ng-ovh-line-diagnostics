...
angular.module("ovh-angular-line-diagnostics").factory("LineDiagnosticFactory", ["DIAGNOSTICS_CONSTANTS", function (DIAGNOSTICS_CONSTANTS) {
    ...
    var LineDiagnostic = function () {
        ...
        _createClass(LineDiagnostic, [{
            ...
            key: "populateDefaultValues",
            value: function populateDefaultValues() {
                var _this9 = this;

                Object.keys(this.data.answers || {}).forEach(function (answer) {
                    _this9.data.answers[answer] = _this9.data.answers[answer] || _this9.getQuestionDefaultValue(answer);
                });
            }
        }, {
...
angular.module('ovh-angular-line-diagnostics').run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put('/ovh-angular-line-diagnostics/src/ovh-angular-line-diagnostics/dialogs/ovh-angular-line-diagnostics-confirm-intervention-dialog.html', "<oui-modal data-heading=\"{{:: 'tools_lineDiagnostics_confirm_modal_title' | translate }}\" data-type=warning data-primary-action=\"$close('ok')\" data-primary-label=\"{{:: 'tools_lineDiagnostics_continue' | translate }}\" data-secondary-action=$dismiss() data-secondary-label=\"{{:: 'tools_lineDiagnostics_cancel' | translate }}\" data-on-dismiss=$dismiss()><p data-translate=tools_lineDiagnostics_confirm_modal_explanation></p><p data-ng-bind=\":: 'tools_lineDiagnostics_confirm_modal_unplug_modem_text' | translate: { continueButtonLabel: ('tools_lineDiagnostics_continue' | translate) }\"></p></oui-modal>");
